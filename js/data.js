...
export const MOCK_CATALOG = [
  ...
  // --- Modelos extra con fotos de internet (siguen tu tarifario) ---
  { id:'16', nombre:'Acrílico Mini Nude — Cortas naturales', imagen_url:'https://images.unsplash.com/photo-1604654894610-df63bc536371?w=600&q=80', tecnica:'Acrílico', color:'Nude Rosé', precio_desde:240, activo:true, ocasion:'diario', tags:['mini','natural'] },
  { id:'17', nombre:'Acrílico Largo 1 — Rosa Pastel Gloss', imagen_url:'https://images.unsplash.com/photo-1632345031435-8727f21d122f?w=600&q=80', tecnica:'Acrílico', color:'Rosa Pastel', precio_desde:250, activo:true, ocasion:'diario', tags:['largo1'] },
  { id:'18', nombre:'Acrílico Largo 2 — Francesa Clásica', imagen_url:'https://images.unsplash.com/photo-1519014816548-bf5fe059798b?w=600&q=80', tecnica:'Acrílico', color:'Blanco Leche', precio_desde:280, activo:true, ocasion:'novia', tags:['frances'] },
  { id:'19', nombre:'Acrílico Largo 3 — Aurora Perla', imagen_url:'https://images.unsplash.com/photo-1522337660859-02fbefca4702?w=600&q=80', tecnica:'Acrílico', color:'Blanco Perla', precio_desde:310, activo:true, ocasion:'fiesta', tags:['aurora'] },
  { id:'20', nombre:'Acrílico Largo 4 — Espejo Champagne', imagen_url:'https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=600&q=80', tecnica:'Acrílico', color:'Dorado Champagne', precio_desde:345, activo:true, ocasion:'fiesta', tags:['espejo'] },
  { id:'21', nombre:'Acrílico Largo 5 — Azúcar Texturizado', imagen_url:'https://images.unsplash.com/photo-1583209814683-c023dd293cc6?w=600&q=80', tecnica:'Acrílico', color:'Rosa Pastel', precio_desde:380, activo:true, ocasion:'fiesta', tags:['azucar'] },
  { id:'22', nombre:'Acrílico Largo 6 — Suéter Invierno', imagen_url:'https://images.unsplash.com/photo-1610992015732-2449b76344bc?w=600&q=80', tecnica:'Acrílico', color:'Nude Rosé', precio_desde:420, activo:true, ocasion:'diario', tags:['sueter'] },
  { id:'23', nombre:'Acrílico Largo 7 — Blooming Acuarela', imagen_url:'https://images.unsplash.com/photo-1604654894610-df63bc536371?w=600&q=80', tecnica:'Acrílico', color:'Multicolor', precio_desde:460, activo:true, ocasion:'fiesta', tags:['blooming'] },
  { id:'24', nombre:'Acrílico Largo 8 — Ojo de Gato Magnético', imagen_url:'https://images.unsplash.com/photo-1632345031435-8727f21d122f?w=600&q=80', tecnica:'Acrílico', color:'Negro Azabache', precio_desde:500, activo:true, ocasion:'fiesta', tags:['ojo_de_gato'] },
  { id:'25', nombre:'Acrílico Largo 9 — Relieve Minimal', imagen_url:'https://images.unsplash.com/photo-1519014816548-bf5fe059798b?w=600&q=80', tecnica:'Acrílico', color:'Blanco Leche', precio_desde:540, activo:true, ocasion:'elegante', tags:['relieve'] },
  { id:'26', nombre:'Acrílico Largo 10 — 3D Flores', imagen_url:'https://images.unsplash.com/photo-1522337660859-02fbefca4702?w=600&q=80', tecnica:'Acrílico', color:'Rosa Pastel', precio_desde:580, activo:true, ocasion:'fiesta', tags:['flores_3d'] },
  { id:'27', nombre:'Acrílico Largo 11 — Cristales Figura', imagen_url:'https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=600&q=80', tecnica:'Acrílico', color:'Dorado Champagne', precio_desde:620, activo:true, ocasion:'fiesta', tags:['cristal'] },
  { id:'28', nombre:'Gel Manos Natural — Brillo Largo', imagen_url:'https://images.unsplash.com/photo-1604654894610-df63bc536371?w=600&q=80', tecnica:'Gel semipermanente manos', color:'Nude Rosé', precio_desde:260, activo:true, ocasion:'oficina', tags:['gel'] },
  { id:'29', nombre:'Baño Acrílico con Encapsulado', imagen_url:'https://images.unsplash.com/photo-1632345031435-8727f21d122f?w=600&q=80', tecnica:'Baño de acrílico', color:'Blanco Leche', precio_desde:320, activo:true, ocasion:'diario', tags:['encapsulado'] },
  { id:'30', nombre:'Acripie Diamante — Pedicura', imagen_url:'https://images.unsplash.com/photo-1583209814683-c023dd293cc6?w=600&q=80', tecnica:'Acripie', color:'Rosa Pastel', precio_desde:300, activo:true, ocasion:'diario', tags:['pies','acripie'] },
  { id:'31', nombre:'Pies Gel Frances — Pedicura', imagen_url:'https://images.unsplash.com/photo-1519014816548-bf5fe059798b?w=600&q=80', tecnica:'Pies gel', color:'Blanco Leche', precio_desde:280, activo:true, ocasion:'diario', tags:['pies','frances'] },
  { id:'32', nombre:'Baby Boomer Nude — Degradado', imagen_url:'https://images.unsplash.com/photo-1522337660859-02fbefca4702?w=600&q=80', tecnica:'Acrílico', color:'Blanco Leche', precio_desde:380, activo:true, ocasion:'novia', tags:['baby_boomer'] },
  { id:'33', nombre:'Sticker Art — Minimal', imagen_url:'https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=600&q=80', tecnica:'Acrílico', color:'Multicolor', precio_desde:345, activo:true, ocasion:'diario', tags:['sticker'] },
  { id:'34', nombre:'Dijes y Moños — Fiesta', imagen_url:'https://images.unsplash.com/photo-1604654894610-df63bc536371?w=600&q=80', tecnica:'Acrílico', color:'Rosa Pastel', precio_desde:420, activo:true, ocasion:'fiesta', tags:['dijes'] },
  { id:'35', nombre:'Nail Art Detallado — Largo 5', imagen_url:'https://images.unsplash.com/photo-1632345031435-8727f21d122f?w=600&q=80', tecnica:'Acrílico', color:'Multicolor', precio_desde:380, activo:true, ocasion:'fiesta', tags:['nail_art'] },
];
